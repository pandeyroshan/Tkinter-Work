...
def mailSetup():
	...
	def mailHistory():
		...
		Label(mailHistoryRoot,text='HISTORY',font="Arial 40",fg='#f03d33',bg='#222022',anchor="center",width=45).grid(row=0,column=0,columnspan=4)
		Label(mailHistoryRoot,text='',bg='#222022').grid(row=1,column=0)
		Label(mailHistoryRoot,text='',bg='#222022').grid(row=2,column=0)
		Label(mailHistoryRoot,text='SENDER',font="Arial 15",fg='#f03d33',bg='#222022',anchor="center").grid(row=3,column=0)
		Label(mailHistoryRoot,text='RECIEVER',font="Arial 15",fg='#f03d33',bg='#222022',anchor="center").grid(row=3,column=1)
		Label(mailHistoryRoot,text='SUBJECT',font="Arial 15",fg='#f03d33',bg='#222022',anchor="center").grid(row=3,column=2)
		Label(mailHistoryRoot,text='DATE/TIME',font="Arial 15",fg='#f03d33',bg='#222022',anchor="center").grid(row=3,column=3)
	...
	Label(root,text="EMAIL SENDING SETUP",font="Arial 40",fg='#f03d33',bg='#222022',width=45).grid(row=0,column=0,columnspan=2)
	...
	Button(root,text="RESET",borderwidth=3,bg='#fdd947',width=30,font='Arial 15',command=reset).grid(row=16,column=0,ipady=5)
	Button(root,text="SEND",borderwidth=3,bg='#fdd947',width=30,font='Arial 15',command=send).grid(row=16,column=1,ipady=5)
	Label(root,text="",bg='#222022').grid(row=17,column=0)
	Label(root,text="",bg='#222022').grid(row=18,column=0)
	Button(root,text="SEND WITH FILE",borderwidth=3,bg='#fdd947',width=30,font='Arial 15',command=sendWithFile).grid(row=19,column=0,ipady=5)
	Button(root,text="HISTORY",borderwidth=3,bg='#fdd947',width=30,font='Arial 15',command=mailHistory).grid(row=19,column=1,ipady=5)
	Label(root,text="",bg='#222022').grid(row=20,column=0)
	root.mainloop()
splashRoot=Tk()
splashRoot.title('SPLASH SCREEN')
splashRoot.after(2000,mailSetup)
...
Label(splashRoot,text='ROSHAN PANDEY',width=46,font='Arial 40 bold',bg='#222022',fg='#f03d33').grid(row=13,column=0,columnspan=2)
